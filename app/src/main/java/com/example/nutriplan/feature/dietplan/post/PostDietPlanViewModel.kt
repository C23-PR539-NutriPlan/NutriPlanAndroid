...
class PostDietPlanViewModel(private val repository: Repository): ViewModel() {
    ...
    fun postForRecomm(user_id : String, user_calories : Int,user_allergies: List<String>?,user_favorites: List<String>?) = repository.postForRecomm(user_id, user_calories, user_allergies, user_favorites)
